        ...
        <div class="card">
            <div class="card-header align-items-center d-flex">
                ...
                <div class="flex-shrink-0">
                    <a href="{{url('/settings/roles/add')}}" class="btn btn-soft-info btn-sm">
                        <i class="ri-add-circle-line align-middle"></i> Add role
                    </a>
                    <a href="{{url('/settings/roles/trash')}}" class="btn btn-soft-danger btn-sm">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="hstack gap-3 flex-wrap">
                                        ...
                                        <a href="javascript:void(0);" onclick="DeleteWithUrl('{{url('/settings/roles/delete/'.$item->id)}}');" class="link-danger fs-15"><i class="ri-delete-bin-line"></i></a>
                                    </div>
                                </td>
                            </tr>
                        @endforeach
